...
### [Link to this](http://sdk.play.date/inside-playdate/\#_structuring_your_project "Link to this") 4.2. Structuring your project
...
### [Link to this](http://sdk.play.date/inside-playdate/\#basic-playdate-game "Link to this") 5.1. A Basic Playdate Game in Lua
...
Playdate’s API is exposed in a Lua namespace called `playdate`. Our API is explained in detail [later in this document](http://sdk.play.date#api-reference).

### [Link to this](http://sdk.play.date/inside-playdate/\#_playdate_lua_api_conventions "Link to this") 5.2. Playdate Lua API conventions

#### [Link to this](http://sdk.play.date/inside-playdate/\#_arrays "Link to this") Arrays
...
#### [Link to this](http://sdk.play.date/inside-playdate/\#_calling_functions "Link to this") Calling functions
...
#### [Link to this](http://sdk.play.date/inside-playdate/\#_return_values "Link to this") Return values
...
### [Link to this](http://sdk.play.date/inside-playdate/\#lua-tips "Link to this") 5.3. Lua Tips

#### [Link to this](http://sdk.play.date/inside-playdate/\#_initialize_variables_with_local "Link to this") Initialize variables with `local`
...
#### [Link to this](http://sdk.play.date/inside-playdate/\#_assign_frequently_used_objects_to_local_variables "Link to this") Assign frequently-used objects to local variables
...
### [Link to this](http://sdk.play.date/inside-playdate/\#_object_oriented_programming_in_lua "Link to this") 5.4. Object-oriented programming in Lua
...
|     |     |
| --- | --- |
| Important | You must import _CoreLibs/object_ to use these functions. |
...
### [Link to this](http://sdk.play.date/inside-playdate/\#_corelibs "Link to this") 5.5. CoreLibs
